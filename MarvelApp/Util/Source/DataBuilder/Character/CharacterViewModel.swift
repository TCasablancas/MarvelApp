...
class CharacterViewModel {
    ...
    private let logic: CharacterLogic
    private let character: Character
    private var sectionKeys = [NSNumber]()
    private var sections = [NSNumber: CharacterSection]() {
    ...
    init(logic: CharacterLogic, character: Character) {
        self.logic = logic
        self.character = character
    }
    
    func loadCharacterData() {
        sections[NSNumber(value: 0)] = .main(viewModels: [CharacterHeaderTableViewCellDTO(character: character, favorited: logic.isFavorite(character: character))], preview: true)
    ...
    func canShowContent(for section: CharacterSection, at indexPath: IndexPath) -> Bool {
    ...
    func characterDetailSection(at indexPath: IndexPath) -> CharacterSection {
        ...
        logic.showOptionsFor(character: character) { (result) in
            ...
            case .favorite:
                self.logic.favorite(self.character, completion: { _ in
                    ...
                    let dto = CharacterHeaderTableViewCellDTO(
...
private extension CharacterHeaderTableViewCellDTO {
