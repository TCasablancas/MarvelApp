...
class CharacterViewController: ViewController<UIView> {
    ...
    private func registerCells() {
        characterDetailTableView.registerCell(of: CharacterHeaderTableViewCell.self)
...
extension CharacterViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        switch model {
        case let dto as CharacterHeaderTableViewCellDTO:
...
//    }
    ...
    func table(_ tableView: UITableView, headerCellAt indexPath: IndexPath, with viewModel: CharacterHeaderTableViewCellDTO?) -> CharacterHeaderTableViewCell {
        let cell = tableView.dequeueReusableCell(CharacterHeaderTableViewCell.self, for: indexPath)
        cell.configure(with: viewModel)
        return cell
    }
